...
$ENTRIES = [
    ...
    ['v1.22 Beta', 'June 30, 2026', 'Consistent period colors across the Market Report — this 60-day period = black, previous 60-day = blue, last-year 60-day = orange — on the comparison chart, the detail table, and the KPI labels. Condition Mix is now full-width and shows the mix as a 60-day trend (this period vs prior 60 vs same period last year) instead of a single period, fixing the cramped/overflowing table.'],
    ['v1.21 Beta', 'June 30, 2026', 'New data format with buyer details. The importer now reads the expanded export (buyer name, company, city, state, type, auction event, reserve price) and derives the sale month from the actual sold date. Buyer data is captured into a separate, access-controlled dataset to power upcoming buyer market reports. Market Report: filtered (searched) views now show the current / prior-60 / same-period-last-year figures on every KPI, with a national-average comparison on price metrics (removed the meaningless "vs national" on the Total Sales count).'],
